...
const Contact: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        // Create mailto link
        const subject = `Contact from ${formData.name} - ${formData.organization}`;
        ...
        window.location.href = `mailto:bowenzhang99@gmail.com?subject=${encodeURIComponent(subject)}&body=${body}`;
        setSubmitted(true);
    };
                ...
                >
                    {submitted ? (
                        <div className="thank-you-message">
                            ...
                            <p>Your email client should have opened. If not, please email us directly at bowenzhang99@gmail.com</p>
